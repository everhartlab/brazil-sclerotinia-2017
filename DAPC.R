...
pdf(here::here("figs/DAPC-scatter.pdf"), width = 3.464565, height = 3.464565, colormodel = "cmyk")
scatter.dapc(CD_DAPC, cex=1.0, scree.da=F, clabel=0, cstar=0, cellipse = 1, legend=T, 
        col=my_palette)                         
dev.off()

pdf(here::here("figs/DAPC-barplot.pdf"), width = 3.464565, height = 3.464565, colormodel = "cmyk")
